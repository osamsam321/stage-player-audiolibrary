...
public class AlbumService {
	...
	{
		System.out.println("Album test: " + repo.getAllAlbumsFromArtistId(id.getId()));
		return Optional.ofNullable(new AllAlbumsELW(repo.getAllAlbumsFromArtistId(id.getId())));
	}
